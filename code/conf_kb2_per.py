...
relative_path = './results_Kfold/results_kb2_kfold_final.txt'  # Tệp nằm trong cùng thư mục với file script
...
output_dir = os.path.join(os.path.dirname(__file__), "confusion_matrices_kb2_percentage")
